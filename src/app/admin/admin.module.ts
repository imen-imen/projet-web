...
@NgModule({
  declarations: [AdminComponent, SessionItemComponent, SessionItemListComponent, SessionAddFormComponent, SessionEditFormComponent, FormateurAddFormComponent, FormateurEditFormComponent, FormateurItemLisComponent,FormateursComponent],
